defmodule Sagents.MiddlewareEntryTest do
  ...
  describe "integration with actual middleware configs" do
    test "converts real Summarization middleware entry correctly" do
      ...
      entry = %MiddlewareEntry{
        id: Sagents.Middleware.Summarization,
        module: Sagents.Middleware.Summarization,
        config: %{
          id: Sagents.Middleware.Summarization,
      ...
      assert module == Sagents.Middleware.Summarization
    ...
    test "converts real FileSystem middleware entry correctly" do
      entry = %MiddlewareEntry{
        id: Sagents.Middleware.FileSystem,
        module: Sagents.Middleware.FileSystem,
        config: %{
          id: Sagents.Middleware.FileSystem,
          middleware_id: Sagents.Middleware.FileSystem,
      ...
      assert module == Sagents.Middleware.FileSystem
