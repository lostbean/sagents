defmodule Sagents.AgentServerMiddlewareMessagingTest do
  use Sagents.BaseCase, async: false

  alias Sagents.{AgentServer, State, Middleware, MiddlewareEntry}
  ...
  describe "middleware registry initialization" do
    test "builds middleware registry with default module name IDs" do
      ...
      assert Enum.all?(state.agent.middleware, fn %Sagents.MiddlewareEntry{id: id} ->
               id != nil
             end)
